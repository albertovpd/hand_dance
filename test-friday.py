# ORIGINAL CODE: https://github.com/sashagaz/Hand_Detection
# i am just trying to perform some changes
...
#from src.music_from_hands import my_sound
...
while(1):
    ...
    #Draw center mass
    cv2.circle(frame,centerMass,10,[100,0,255],2)
    ...
    ## RESULT VA DE 1 A 5, son los finger        
            print(result)
